        ...
        <main className="dash-inner">
          <div className="profile">
            <div className="profile__buttons">
              <ProfileButton text={titles['edit_btn']} addedClassName="profile-button-edit" clickHandler={this.editAction} />
            ...
            <div className="profile__form">
              ...
              <FormField label={titles['investor.bank.label']} addedClassName="" id='profile__bank'>
                <Select
