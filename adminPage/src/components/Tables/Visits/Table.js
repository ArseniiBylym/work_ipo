...
class TableContainer extends Component {
    ...
    confirmDelete() {
        ...
        axios.delete(`/adminpanel/visits/${this.state.DeleteItemId}`, {
            headers: {
                token: token
            }
        })
    ...
    saveChanges(item) {
        ...
        const token = ls.get('token')
        if (item.key) {
            axios.post(`/adminpanel/visits/`, item, {
                headers: {
                    token: token
                }
            })
            ...
            axios.put(`/adminpanel/visits/${item.id}`, item, {
                headers: {
                    token: token
                }
            })
