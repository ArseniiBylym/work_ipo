...
class TableContainer extends Component {
    ...
    confirmDelete() {
        ...
        axios.delete(`/adminpanel/purchaseStatuses/${this.state.DeleteItemId}`, {
            headers: {
                token: token
            }
        })
    ...
    saveChanges(item) {
        ...
        const token = ls.get('token')
        if (item.key) {
            axios.post(`/adminpanel/purchaseStatuses/`, item, {
                headers: {
                    token: token
                }
            })
            ...
            axios.put(`/adminpanel/purchaseStatuses/${item.id}`, item, {
                headers: {
                    token: token
                }
            })
    ...
    getTableData() {
        ...
        const token = ls.get('token')
        axios.get(`/adminpanel/purchaseStatuses`, {
            headers: {
                token: token
            }
        })
